    ...
    def get_customizable_model_schema(
        ...
        entity.parameter_rules += [
            ...
            ParameterRule(
                ...
                label=I18nObject(en_US="Thinking Budget", zh_Hans="思考预算"),
                help=I18nObject(
                    en_US="Maximum number of tokens to use for the thinking process (0-1000).",
                    zh_Hans="思考过程使用的最大token数（0-1000）。",
                ),
